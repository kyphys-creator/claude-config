...
| `sensitive-terms.txt` | odakin-prefs (gitignore, Dropbox symlink) | literal 正本 (9 entries: 組織名 3 + 間接 context 4 + 部門名 1 + collaborator 名 1。TWCU は研究略称として公開使用 OK と判断し 2026-04-10 に除外) |
